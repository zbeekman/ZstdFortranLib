...
function(get_vcs_info)
  ...
  #   GIT_PROJECT_ROOT
  #   GIT_SUBPROJECT_ROOT
  #   GIT_VERSION: output of git dscribe --abbreve=0 validated to be a tag version string
  #   GIT_FULL_DESCRIBE: output of git describe --always
  #   GIT_LAST_TAG: Same as GIT_VERSION but without validation
  #   COMMIT_DATE_UNIX_TIME: Commit date in unix time suitable for setting SOURCE_DATE_EPOCH
  #   GIT_COMMIT_HASH: The SHA1 hash of the HEAD (last) commit

  if(EXISTS "${CMAKE_SOURCE_DIR}/.git")
    set(GIT_PROJECT_ROOT ${CMAKE_SOURCE_DIR} PARENT_SCOPE)
  ...
  if( (NOT CMAKE_SOURCE_DIR STREQUAL CMAKE_CURRENT_SOURCE_DIR) AND EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/.git")
    set(GIT_SUBPROJECT_ROOT ${CMAKE_CURRENT_SOURCE_DIR} PARENT_SCOPE)
  ...
  if(WORKING_GIT_ROOT)
    ...
    if(GIT_FOUND)
      ...
      set(GIT_FULL_DESCRIBE ${GIT_FULL_DESCRIBE} PARENT_SCOPE)
      set(GIT_LAST_TAG ${GIT_LAST_TAG} PARENT_SCOPE)
      set(COMMIT_DATE_UNIX_TIME ${COMMIT_DATE_UNIX_TIME} PARENT_SCOPE)
