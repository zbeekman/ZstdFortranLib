module zsfl_testing_interface
  ...
  contains
    ...
    procedure(logical_fn_comparison_r4), deferred :: within_r4
    procedure(logical_fn_comparison_r8), deferred :: within_r8
    procedure(logical_fn_comparison_r10), deferred :: within_r10
    procedure(logical_fn_comparison_r16), deferred :: within_r16
  ...
  abstract interface
    ...
    pure module function logical_fn_comparison_r4(this,tol) result(res)
      class(comparison_t), intent(in) :: this
      real(4), intent(in) :: tol
      logical :: res
    end function
    pure module function logical_fn_comparison_r8(this,tol) result(res)
      class(comparison_t), intent(in) :: this
      real(8), intent(in) :: tol
      logical :: res
    end function
    pure module function logical_fn_comparison_r10(this,tol) result(res)
      class(comparison_t), intent(in) :: this
      real(10), intent(in) :: tol
      logical :: res
    end function
    pure module function logical_fn_comparison_r16(this,tol) result(res)
      class(comparison_t), intent(in) :: this
