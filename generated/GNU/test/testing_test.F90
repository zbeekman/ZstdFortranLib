program testing_test
  ...
  real(kind=r4) :: tolerance_r4 = 10000 * epsilon(1.0_r4)
  real(kind=r4) :: rtolerance_r4 = (10000/100) * epsilon(1.0_r4)
  real(kind=r4) :: one_hundred_r4 = 100.0_r4
  integer, parameter :: r8 = 8
  real(kind=r8) :: tolerance_r8 = 10000 * epsilon(1.0_r8)
  real(kind=r8) :: rtolerance_r8 = (10000/100) * epsilon(1.0_r8)
  real(kind=r8) :: one_hundred_r8 = 100.0_r8
  integer, parameter :: r10 = 10
  real(kind=r10) :: tolerance_r10 = 10000 * epsilon(1.0_r10)
  real(kind=r10) :: rtolerance_r10 = (10000/100) * epsilon(1.0_r10)
  real(kind=r10) :: one_hundred_r10 = 100.0_r10
  integer, parameter :: r16 = 16
  real(kind=r16) :: tolerance_r16 = 10000 * epsilon(1.0_r16)
  real(kind=r16) :: rtolerance_r16 = (10000/100) * epsilon(1.0_r16)
  real(kind=r16) :: one_hundred_r16 = 100.0_r16
